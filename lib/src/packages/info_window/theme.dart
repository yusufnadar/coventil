...
class CityTheme {
  ...
  static Color cityBlue = const Color(0xFF2669A4);
  static Color cityWhite = const Color(0xFFFFFFFF);
  static Color cityBlack = const Color(0xFF3E3D3D);

  static ThemeData theme = ThemeData(
    primaryColor: cityBlue,
    colorScheme: ColorScheme.dark(surface: cityWhite),
  );
}
